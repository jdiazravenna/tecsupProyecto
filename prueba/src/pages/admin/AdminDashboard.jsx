    ...
    return (
        <div>
            ...
            <div className="top mb-5 px-5 mt-5">
                <div className=" bg-teal-700 py-5 border border-pink-100 rounded-lg">
            ...
            <div className="px-5">
                ...
                <div className="mid mb-5">
                    {/* main  */}
                    <div className=" bg-teal-400 py-5 rounded-xl border border-pink-100">
                        {/* image  */}
                    ...
                    <Tabs>
                        <TabList className="flex flex-wrap -m-4 text-center justify-center">
                            ...
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-teal-400 hover:bg-teal-500 border-pink-100 px-4 py-3 rounded-xl" >
                            ...
                            {/* Total User  */}
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-teal-400 hover:bg-teal-500 border-white px-4 py-3 rounded-xl" >
                                    <div className="text-white w-12 h-12 mb-3 inline-block" >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width={50}
